...
@NgModule({
  ...
  providers: [basehttpInterceptorProviders, httpInterceptorProviders, MeetingDataService, MeetingResolver, AuthenticationService, AuthGuardService, PreferenceResolver, LikedMeetingsResolver, GoingMeetingsResolver],
